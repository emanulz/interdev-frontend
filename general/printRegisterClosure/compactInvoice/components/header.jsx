...
export default class Header extends React.Component {
  ...
  render() {
    ...
    const headertext = 'Cierre de Caja'
    ...
    return <div>
      ...
      <div className='print-register-closure-compact-invoice-header'>

        <div className='print-register-closure-compact-invoice-header-info'>
      ...
      <div className='print-register-closure-compact-invoice-separator'>
        <span />
