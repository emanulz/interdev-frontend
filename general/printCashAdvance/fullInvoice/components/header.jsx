...
export default class Header extends React.Component {
  ...
  render() {
    const headertext = 'Recibo por Adelanto de Dinero'
    ...
    return <div>
      ...
      <div className='cash-advance-full-invoice-header'>

        <div className='cash-advance-full-invoice-header-logo'>
          <img style={{'width': `${logoWidth}`}} src={logoUrl} />
        </div>
        <div className='cash-advance-full-invoice-header-info'>
      ...
      <div className='cash-advance-full-invoice-separator'>
        <span />
