...
export default class ListFileTransfers extends React.Component {
    ...
    componentWillMount(){
        ...
        const transferKwargs = {
            url : `/api/filetransferslist/?limit=${this.props.pageSize}`,
    ...
    render(){
        ...
        const paginationDiv = !this.props.searchResults.length
            ...
            <ResultsPerPage url='/api/filetransferslist/' successType='FETCH_FTRANSFERS_FULFILLED' errorType='FETCH_FTRANSFERS_REJECTED' />
            <Pagination url='/api/filetransferslist/' successType='FETCH_FTRANSFERS_FULFILLED' errorType='FETCH_FTRANSFERS_REJECTED' />
            </div>
            : <div />
