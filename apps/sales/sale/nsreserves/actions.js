...
export function loadNSReserve(url, resolve, reject) {
  return function() {
...
// ------------------------------------------------------------------------------------------
export function getPendingNSReserves(kwargs) {
  ...
  const urltoFetch = `${url}/?${filterField}=${filter}&${filterField2}=${filter2}&${filterField3}=${filter3}&presale_type=NS_RESERVE&ordering=${ordering}&limit=100`
...
export function setNSReserveNull(id, resolve, reject) {
