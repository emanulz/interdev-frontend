...
export function loadRestaurantBill(url, resolve, reject) {
  return function() {
...
// ------------------------------------------------------------------------------------------
export function getPendingRestaurantBills(kwargs) {
...
export function setRestaurantBillNull(id, resolve, reject) {
