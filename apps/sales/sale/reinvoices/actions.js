...
export function loadReinvoice(url, resolve, reject) {
  return function() {
...
// ------------------------------------------------------------------------------------------
export function getPendingReinvoices(kwargs) {
  ...
  const urltoFetch = `${url}/?${filterField}=${filter}&${filterField2}=${filter2}&${filterField3}=${filter3}&presale_type=RE_INVOICE&ordering=${ordering}&limit=100`
...
export function setReinvoiceNull(id, resolve, reject) {
