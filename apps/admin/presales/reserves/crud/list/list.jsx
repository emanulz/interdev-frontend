  ...
  render() {
    ...
    const paginationDiv = !this.props.searchResults.length
      ? <div className='admin-list-results-pagination' >
        <ResultsPerPage url='/api/presales/?presale_type=RESERVES' successType='FETCH_RESERVES_PRESALES_FULFILLED' errorType='FETCH_RESERVES_PRESALES_REJECTED' />
        <Pagination url='/api/presales/?presale_type=RESERVES' successType='FETCH_RESERVES_PRESALES_FULFILLED' errorType='FETCH_RESERVES_PRESALES_REJECTED' />
      </div>
      : <div />
