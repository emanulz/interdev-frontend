...
@connect((store) => {
  return {
    ...
    productDepartments: store.clientCategories.clientCategories
  }
})
  ...
  render() {
    ...
    return <div className='create heigh100'>
      <div className='create-edit-header'>
        <h1>CREAR CATEGORÍA DE CLIENTE</h1>
      ...
      <ItemsBar items={this.props.productDepartments} tittle='Lista de Familias de Producto' codeField='code'
        descriptionField='name' descriptionField2={false} editPath='/admin/clientcategories/edit/' />
    </div>
