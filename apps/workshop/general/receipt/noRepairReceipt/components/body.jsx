...
export default class NoRepairBody extends React.Component{
    ...
    render(){
        ...
        return <div className ='compact-warrantyBD'>
            ...
            {
                this.props.requestList.length>0?
                <div className='compact-receipt-separator'>
                <span/>
                    <h2>Requisiciones</h2>
                <span/>
    ...
    buildArticleCashAdvances(){
        const base_class = 'compact-receipt-data-field'
        const cash_advances = this.props.cashAdvanceList.map((a, index)=>{
