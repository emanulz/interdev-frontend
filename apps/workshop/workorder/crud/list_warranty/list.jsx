...
export default class List_Warranty extends React.Component {
    ...
    componentWillMount(){
        ...
        const workordersKwargs = {
            url: `/api/listwarrantyworkorders/?limit=${this.props.pageSize}&ordering=-consecutive`,
    ...
    render(){
        ...
        return <div className='list list-container'>
            ...
            <div className='admin-list-results-pagination' >
                <ResultsPerPage url='/api/listwarrantyworkorders/?ordering=-consecutive' successType='FETCH_WORKORDERS_FULFILLED' errorType='FETCH_WORKORDERS_REJECTED' />
                <Pagination url='/api/listwarrantyworkorders/?ordering=-consecutive' successType='FETCH_WORKORDERS_FULFILLED' errorType='FETCH_WORKORDERS_REJECTED' />
            </div>
